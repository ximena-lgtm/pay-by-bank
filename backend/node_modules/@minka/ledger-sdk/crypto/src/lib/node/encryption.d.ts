/**
 * Payload structure for AES encrypted data.
 */
export type EncryptedAESPayload = {
    value: string;
    iv: string;
    authTag: string;
    keyVersion?: string;
 ...
 * @param keyVersion Optional. Version of the key used for encryption, if applicable. This is useful for key rotation scenarios
 ...
 */
declare function encryptAES(payload: string, aesKey: string | Buffer, keyVersion?: string, ivHex?: string): {
    packed: string;
    unpacked: {
        value: string;
        iv: string;
 ...
 */
export declare function exportAESEncrypted(encryptedUnpacked: EncryptedAESPayload): string;
/**
 ...
 */
export declare function importAESEncrypted(encryptedPacked: string): EncryptedAESPayload;
/**
 * Asserts that the given string is a valid encoded `EncryptedAESPayload`
 * @param value Packed string to check
 * @returns boolean
 */
export declare function isAESEncryptedPackage(value: string): boolean;
